#
"""
Split step Fourier Integration code adapted from:
https://www.algorithm-archive.org/contents/split-operator_method/split-operator_method.html

Integrates the Nonlinear Schroedinger Equation (NLSE):

  𝒾ħ( ∂/∂t ) Ψ(r,t) = [ -( ħ²/2m )∇² + V(r) + g|Ψ(r,t)|² ] Ψ(r,t)                             (1)

using the "split-step" approach:

  Ψ(r,t+dt) = [ exp( -𝒾Ĥᵣdt/2ħ ) ] [ exp( -𝒾Ĥₖdt/ħ ) ] [ exp( -𝒾Ĥᵣdt/2ħ ) ] Ψ(r,t) + 𝒪(dt³)   (2)
