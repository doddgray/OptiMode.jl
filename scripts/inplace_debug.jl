using Revise, LinearAlgebra, StaticArrays, FFTW, BenchmarkTools, LinearMaps, IterativeSolvers, KrylovKit, Roots
using OptiMode
using Plots: heatmap
SHM3 = SHermitianCompact{3,Float64,6}
LinearAlgebra.ldiv!(c,A::LinearMaps.LinearMap,b) = mul!(c,A',b)
# MPB solve for reference
using PyCall, Plots, StaticArrays, GeometryPrimitives, BenchmarkTools, FFTW, LinearMaps, IterativeSolvers # Arpack, BBQPM, IterativeSolvers, KrylovKit
mp = pyimport("meep")
