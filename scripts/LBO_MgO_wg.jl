...
function proc_modes_shg(oms,pp,kk_ev;pol_idx_fund=1,mode_order_fund=(0,0),pol_idx_sh=1,mode_order_sh=(0,0),rel_amp_min=0.1,num_bands=size(first(first(kk_ev)))[2])
    ks, evecs = kk_ev
...
function proc_modes_shg_LBOy(oms,pp,kk_ev;mode_order_fund=(0,0),mode_order_sh=(0,0),rel_amp_min=0.1,num_bands=size(first(first(kk_ev)))[2])
...
function proc_modes_shg_LBOz(oms,pp,kk_ev;mode_order_fund=(0,0),mode_order_sh=(0,0),rel_amp_min=0.1,num_bands=size(first(first(kk_ev)))[2])
