...
1. "Thermo-optic dispersion formula for the ordinary wave in 5 mol% MgO doped 
LiNbO3 and its application to temperature insensitive second-harmonic generation" 
by Umemura and Matsuda, Optics Communications 367 (2016).
2. "Sellmeier and thermo-optic dispersion formulas for the extraordinary ray of
5 mol. % MgO-doped congruent LiNbO 3 in the visible, infrared, and terahertz 
regions", Umemura, et al., Applied Optics Vol. 53 No. 25 (2014).

This model incorporates only the short-wavelength extraordinary index formulation, 
avoding the model transition at 2.7 μm. 

This model is valid from 0.53 μm to 2.7 μm.
...
"""
function nₒ²_MgO_LiNbO₃_sym(λ, T; a₁, a₂, a₃, b₁, b₂, c₀, c₁, c₂, c₃, c₄, d₁, T₀)
	ΔT = T-T₀
...
function nₒ²_MgO_LiNbO₃_sym_ω(ω, T; a₁, a₂, a₃, b₁, b₂, c₀, c₁, c₂, c₃, c₄, d₁, T₀)
    ΔT = T-T₀
...
function nₑ²_MgO_LiNbO₃_sym(λ, T; a₁, a₂, a₃, b₁, c₀₀, c₀, c₁, c₂, c₃, d₁, T₀)
	ΔT = T-T₀
...
function nₑ²_MgO_LiNbO₃_sym_ω(ω, T; a₁, a₂, a₃, b₁, c₀, c₁, c₂, c₃, d₁, T₀)
	ΔT = T-T₀
